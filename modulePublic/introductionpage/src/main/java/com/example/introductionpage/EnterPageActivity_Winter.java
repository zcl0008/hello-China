...
@Route(path = "/introductionpage/EnterPageActivity_Winter")
public class EnterPageActivity_Winter extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enter_page_winter);
    ...
    public void initGif(){
        ...
        Glide.with(this)
                .asGif()
                .load(R.drawable.enter_background_winter)
